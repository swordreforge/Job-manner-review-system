...
(4,1,'RSA','{\"A\":4,\"R\":9,\"S\":5}','[\"技工\",\"程序员\",\"技术员\",\"社工\",\"设计师\",\"作家\",\"音乐家\",\"工程师\",\"建筑师\",\"心理咨询师\",\"销售\",\"艺术家\",\"编辑\",\"教师\",\"人力资源\"]','您的职业兴趣组合为RSA，主要特征包括实际型(Realistic)、社会型(Social)、艺术型(Artistic)。您适合从事程序员、销售、社工、工程师、技工、人力资源、艺术家、建筑师、教师、作家、编辑、音乐家、技术员、心理咨询师、设计师等职业方向。',1775811362);
...
(1,3,5,45.00,'[\"产品规划与需求分析\",\"用户研究与用户体验设计\",\"数据分析与商业洞察\",\"项目管理与跨团队协作\",\"市场竞品分析\"]','1. 学习产品方法论：通过书籍（如《启示录》《结网》）、在线课程（如Coursera产品管理专项）系统学习产品知识；2. 实践产品技能：尝试在现有工作中参与需求评审、用户调研，或通过虚拟项目（如输出竞品分析、产品原型）积累经验；3. 考取认证：如NPDP（产品经理国际资格认证）提升专业背书；4. 拓展商业知识：学习基础数据分析（SQL、Tableau）、市场营销及商业模式课程。',NULL,NULL,NULL,1775811178,1775811178);
